...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EChurnRiskLevel();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions();
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EDisplayPropertyType();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EResetInterval();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_ERoutingType();
...
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EUserFamilyType();
PLAYFAB_API UEnum* Z_Construct_UEnum_PlayFab_EUserOrigination();
UPackage* Z_Construct_UPackage__Script_PlayFab();
// End Cross Module References

// Begin Enum EAuthTokenType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAuthTokenType;
static UEnum* EAuthTokenType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAuthTokenType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAuthTokenType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAuthTokenType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAuthTokenType"));
	}
	return Z_Registration_Info_UEnum_EAuthTokenType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAuthTokenType>()
{
	return EAuthTokenType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAuthTokenType",
	"EAuthTokenType",
	Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAuthTokenType()
{
	if (!Z_Registration_Info_UEnum_EAuthTokenType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAuthTokenType.InnerSingleton, Z_Construct_UEnum_PlayFab_EAuthTokenType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAuthTokenType.InnerSingleton;
}
// End Enum EAuthTokenType

// Begin Enum EChurnRiskLevel
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EChurnRiskLevel;
static UEnum* EChurnRiskLevel_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EChurnRiskLevel.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EChurnRiskLevel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EChurnRiskLevel, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EChurnRiskLevel"));
	}
	return Z_Registration_Info_UEnum_EChurnRiskLevel.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EChurnRiskLevel>()
{
	return EChurnRiskLevel_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** ChurnRiskLevel */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_HighRisk.DisplayName", "HighRisk" },
		{ "pfenum_HighRisk.Name", "EChurnRiskLevel::pfenum_HighRisk" },
		{ "pfenum_LowRisk.DisplayName", "LowRisk" },
		{ "pfenum_LowRisk.Name", "EChurnRiskLevel::pfenum_LowRisk" },
		{ "pfenum_MediumRisk.DisplayName", "MediumRisk" },
		{ "pfenum_MediumRisk.Name", "EChurnRiskLevel::pfenum_MediumRisk" },
		{ "pfenum_NoData.DisplayName", "NoData" },
		{ "pfenum_NoData.Name", "EChurnRiskLevel::pfenum_NoData" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "ChurnRiskLevel" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EChurnRiskLevel::pfenum_NoData", (int64)EChurnRiskLevel::pfenum_NoData },
		{ "EChurnRiskLevel::pfenum_LowRisk", (int64)EChurnRiskLevel::pfenum_LowRisk },
		{ "EChurnRiskLevel::pfenum_MediumRisk", (int64)EChurnRiskLevel::pfenum_MediumRisk },
		{ "EChurnRiskLevel::pfenum_HighRisk", (int64)EChurnRiskLevel::pfenum_HighRisk },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EChurnRiskLevel",
	"EChurnRiskLevel",
	Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EChurnRiskLevel()
{
	if (!Z_Registration_Info_UEnum_EChurnRiskLevel.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EChurnRiskLevel.InnerSingleton, Z_Construct_UEnum_PlayFab_EChurnRiskLevel_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EChurnRiskLevel.InnerSingleton;
}
// End Enum EChurnRiskLevel

// Begin Enum EConditionals
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EConditionals;
static UEnum* EConditionals_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EConditionals.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EConditionals.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EConditionals, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EConditionals"));
	}
	return Z_Registration_Info_UEnum_EConditionals.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EConditionals>()
{
	return EConditionals_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EConditionals_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EConditionals_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EConditionals",
	"EConditionals",
	Z_Construct_UEnum_PlayFab_EConditionals_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EConditionals_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EConditionals_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EConditionals_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EConditionals()
{
	if (!Z_Registration_Info_UEnum_EConditionals.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EConditionals.InnerSingleton, Z_Construct_UEnum_PlayFab_EConditionals_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EConditionals.InnerSingleton;
}
// End Enum EConditionals

// Begin Enum EContinentCode
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EContinentCode;
static UEnum* EContinentCode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EContinentCode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EContinentCode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EContinentCode, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EContinentCode"));
	}
	return Z_Registration_Info_UEnum_EContinentCode.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EContinentCode>()
{
	return EContinentCode_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EContinentCode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_Unknown.Name", "EContinentCode::pfenum_Unknown" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EContinentCode::pfenum_Unknown", (int64)EContinentCode::pfenum_Unknown },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EContinentCode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EContinentCode",
	"EContinentCode",
	Z_Construct_UEnum_PlayFab_EContinentCode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EContinentCode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EContinentCode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EContinentCode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EContinentCode()
{
	if (!Z_Registration_Info_UEnum_EContinentCode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EContinentCode.InnerSingleton, Z_Construct_UEnum_PlayFab_EContinentCode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EContinentCode.InnerSingleton;
}
// End Enum EContinentCode

// Begin Enum ECountryCode
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ECountryCode;
static UEnum* ECountryCode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ECountryCode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ECountryCode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ECountryCode, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ECountryCode"));
	}
	return Z_Registration_Info_UEnum_ECountryCode.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ECountryCode>()
{
	return ECountryCode_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ECountryCode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_Unknown.DisplayName", "Unknown" },
		{ "pfenum_Unknown.Name", "ECountryCode::pfenum_Unknown" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ECountryCode::pfenum_Unknown", (int64)ECountryCode::pfenum_Unknown },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ECountryCode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ECountryCode",
	"ECountryCode",
	Z_Construct_UEnum_PlayFab_ECountryCode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECountryCode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECountryCode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ECountryCode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ECountryCode()
{
	if (!Z_Registration_Info_UEnum_ECountryCode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECountryCode.InnerSingleton, Z_Construct_UEnum_PlayFab_ECountryCode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ECountryCode.InnerSingleton;
}
// End Enum ECountryCode

// Begin Enum ECurrency
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ECurrency;
static UEnum* ECurrency_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ECurrency.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ECurrency.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ECurrency, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ECurrency"));
	}
	return Z_Registration_Info_UEnum_ECurrency.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ECurrency>()
{
	return ECurrency_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ECurrency_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ECurrency_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ECurrency",
	"ECurrency",
	Z_Construct_UEnum_PlayFab_ECurrency_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECurrency_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECurrency_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ECurrency_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ECurrency()
{
	if (!Z_Registration_Info_UEnum_ECurrency.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECurrency.InnerSingleton, Z_Construct_UEnum_PlayFab_ECurrency_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ECurrency.InnerSingleton;
}
// End Enum ECurrency
...
static UEnum* EEffectType_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_EEffectType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EEffectType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EEffectType"));
	}
...
struct Z_Construct_UEnum_PlayFab_EEffectType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EEffectType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EEffectType",
	"EEffectType",
	Z_Construct_UEnum_PlayFab_EEffectType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EEffectType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EEffectType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EEffectType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EEffectType()
{
	if (!Z_Registration_Info_UEnum_EEffectType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EEffectType.InnerSingleton, Z_Construct_UEnum_PlayFab_EEffectType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EEffectType.InnerSingleton;
}
// End Enum EEffectType

// Begin Enum EEmailVerificationStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EEmailVerificationStatus;
static UEnum* EEmailVerificationStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EEmailVerificationStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EEmailVerificationStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EEmailVerificationStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EEmailVerificationStatus"));
	}
	return Z_Registration_Info_UEnum_EEmailVerificationStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EEmailVerificationStatus>()
{
	return EEmailVerificationStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EEmailVerificationStatus",
	"EEmailVerificationStatus",
	Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EEmailVerificationStatus()
{
	if (!Z_Registration_Info_UEnum_EEmailVerificationStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EEmailVerificationStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_EEmailVerificationStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EEmailVerificationStatus.InnerSingleton;
}
// End Enum EEmailVerificationStatus

// Begin Enum ELoginIdentityProvider
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ELoginIdentityProvider;
static UEnum* ELoginIdentityProvider_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ELoginIdentityProvider.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ELoginIdentityProvider.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ELoginIdentityProvider, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ELoginIdentityProvider"));
	}
	return Z_Registration_Info_UEnum_ELoginIdentityProvider.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ELoginIdentityProvider>()
{
	return ELoginIdentityProvider_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_GooglePlayGames.DisplayName", "GooglePlayGames" },
		{ "pfenum_GooglePlayGames.Name", "ELoginIdentityProvider::pfenum_GooglePlayGames" },
		{ "pfenum_IOSDevice.DisplayName", "IOSDevice" },
		{ "pfenum_IOSDevice.Name", "ELoginIdentityProvider::pfenum_IOSDevice" },
		{ "pfenum_King.DisplayName", "King" },
		{ "pfenum_King.Name", "ELoginIdentityProvider::pfenum_King" },
		...
		{ "pfenum_XboxMobileStore.DisplayName", "XboxMobileStore" },
		{ "pfenum_XboxMobileStore.Name", "ELoginIdentityProvider::pfenum_XboxMobileStore" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ELoginIdentityProvider::pfenum_GooglePlayGames", (int64)ELoginIdentityProvider::pfenum_GooglePlayGames },
		{ "ELoginIdentityProvider::pfenum_XboxMobileStore", (int64)ELoginIdentityProvider::pfenum_XboxMobileStore },
		{ "ELoginIdentityProvider::pfenum_King", (int64)ELoginIdentityProvider::pfenum_King },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ELoginIdentityProvider",
	"ELoginIdentityProvider",
	Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ELoginIdentityProvider()
{
	if (!Z_Registration_Info_UEnum_ELoginIdentityProvider.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELoginIdentityProvider.InnerSingleton, Z_Construct_UEnum_PlayFab_ELoginIdentityProvider_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ELoginIdentityProvider.InnerSingleton;
}
// End Enum ELoginIdentityProvider

// Begin Enum EPushNotificationPlatform
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPushNotificationPlatform;
static UEnum* EPushNotificationPlatform_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPushNotificationPlatform.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPushNotificationPlatform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPushNotificationPlatform, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPushNotificationPlatform"));
	}
	return Z_Registration_Info_UEnum_EPushNotificationPlatform.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPushNotificationPlatform>()
{
	return EPushNotificationPlatform_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPushNotificationPlatform",
	"EPushNotificationPlatform",
	Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPushNotificationPlatform()
{
	if (!Z_Registration_Info_UEnum_EPushNotificationPlatform.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPushNotificationPlatform.InnerSingleton, Z_Construct_UEnum_PlayFab_EPushNotificationPlatform_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPushNotificationPlatform.InnerSingleton;
}
// End Enum EPushNotificationPlatform

// Begin Enum EPushSetupPlatform
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPushSetupPlatform;
static UEnum* EPushSetupPlatform_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPushSetupPlatform.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPushSetupPlatform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPushSetupPlatform, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPushSetupPlatform"));
	}
	return Z_Registration_Info_UEnum_EPushSetupPlatform.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPushSetupPlatform>()
{
	return EPushSetupPlatform_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPushSetupPlatform",
	"EPushSetupPlatform",
	Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPushSetupPlatform()
{
	if (!Z_Registration_Info_UEnum_EPushSetupPlatform.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPushSetupPlatform.InnerSingleton, Z_Construct_UEnum_PlayFab_EPushSetupPlatform_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPushSetupPlatform.InnerSingleton;
}
// End Enum EPushSetupPlatform

// Begin Enum EResolutionOutcome
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EResolutionOutcome;
static UEnum* EResolutionOutcome_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EResolutionOutcome.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EResolutionOutcome.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EResolutionOutcome, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EResolutionOutcome"));
	}
	return Z_Registration_Info_UEnum_EResolutionOutcome.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EResolutionOutcome>()
{
	return EResolutionOutcome_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EResolutionOutcome",
	"EResolutionOutcome",
	Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EResolutionOutcome()
{
	if (!Z_Registration_Info_UEnum_EResolutionOutcome.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EResolutionOutcome.InnerSingleton, Z_Construct_UEnum_PlayFab_EResolutionOutcome_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EResolutionOutcome.InnerSingleton;
}
// End Enum EResolutionOutcome

// Begin Enum EResultTableNodeType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EResultTableNodeType;
static UEnum* EResultTableNodeType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EResultTableNodeType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EResultTableNodeType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EResultTableNodeType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EResultTableNodeType"));
	}
	return Z_Registration_Info_UEnum_EResultTableNodeType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EResultTableNodeType>()
{
	return EResultTableNodeType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EResultTableNodeType",
	"EResultTableNodeType",
	Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EResultTableNodeType()
{
	if (!Z_Registration_Info_UEnum_EResultTableNodeType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EResultTableNodeType.InnerSingleton, Z_Construct_UEnum_PlayFab_EResultTableNodeType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EResultTableNodeType.InnerSingleton;
}
// End Enum EResultTableNodeType

// Begin Enum EScheduledTaskType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EScheduledTaskType;
static UEnum* EScheduledTaskType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EScheduledTaskType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EScheduledTaskType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EScheduledTaskType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EScheduledTaskType"));
	}
	return Z_Registration_Info_UEnum_EScheduledTaskType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EScheduledTaskType>()
{
	return EScheduledTaskType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EScheduledTaskType",
	"EScheduledTaskType",
	Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EScheduledTaskType()
{
	if (!Z_Registration_Info_UEnum_EScheduledTaskType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EScheduledTaskType.InnerSingleton, Z_Construct_UEnum_PlayFab_EScheduledTaskType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EScheduledTaskType.InnerSingleton;
}
// End Enum EScheduledTaskType

// Begin Enum ESegmentCountryCode
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESegmentCountryCode;
static UEnum* ESegmentCountryCode_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESegmentCountryCode.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESegmentCountryCode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESegmentCountryCode, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESegmentCountryCode"));
	}
	return Z_Registration_Info_UEnum_ESegmentCountryCode.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESegmentCountryCode>()
{
	return ESegmentCountryCode_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESegmentCountryCode",
	"ESegmentCountryCode",
	Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESegmentCountryCode()
{
	if (!Z_Registration_Info_UEnum_ESegmentCountryCode.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESegmentCountryCode.InnerSingleton, Z_Construct_UEnum_PlayFab_ESegmentCountryCode_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESegmentCountryCode.InnerSingleton;
}
// End Enum ESegmentCountryCode

// Begin Enum ESegmentCurrency
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESegmentCurrency;
static UEnum* ESegmentCurrency_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESegmentCurrency.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESegmentCurrency.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESegmentCurrency, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESegmentCurrency"));
	}
	return Z_Registration_Info_UEnum_ESegmentCurrency.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESegmentCurrency>()
{
	return ESegmentCurrency_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESegmentCurrency",
	"ESegmentCurrency",
	Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESegmentCurrency()
{
	if (!Z_Registration_Info_UEnum_ESegmentCurrency.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESegmentCurrency.InnerSingleton, Z_Construct_UEnum_PlayFab_ESegmentCurrency_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESegmentCurrency.InnerSingleton;
}
// End Enum ESegmentCurrency

// Begin Enum ESegmentFilterComparison
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESegmentFilterComparison;
static UEnum* ESegmentFilterComparison_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESegmentFilterComparison.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESegmentFilterComparison.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESegmentFilterComparison, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESegmentFilterComparison"));
	}
	return Z_Registration_Info_UEnum_ESegmentFilterComparison.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESegmentFilterComparison>()
{
	return ESegmentFilterComparison_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESegmentFilterComparison",
	"ESegmentFilterComparison",
	Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESegmentFilterComparison()
{
	if (!Z_Registration_Info_UEnum_ESegmentFilterComparison.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESegmentFilterComparison.InnerSingleton, Z_Construct_UEnum_PlayFab_ESegmentFilterComparison_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESegmentFilterComparison.InnerSingleton;
}
// End Enum ESegmentFilterComparison

// Begin Enum ESegmentLoginIdentityProvider
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider;
static UEnum* ESegmentLoginIdentityProvider_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESegmentLoginIdentityProvider"));
	}
	return Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESegmentLoginIdentityProvider>()
{
	return ESegmentLoginIdentityProvider_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_GooglePlayGames.DisplayName", "GooglePlayGames" },
		{ "pfenum_GooglePlayGames.Name", "ESegmentLoginIdentityProvider::pfenum_GooglePlayGames" },
		{ "pfenum_IOSDevice.DisplayName", "IOSDevice" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ESegmentLoginIdentityProvider::pfenum_GooglePlayGames", (int64)ESegmentLoginIdentityProvider::pfenum_GooglePlayGames },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESegmentLoginIdentityProvider",
	"ESegmentLoginIdentityProvider",
	Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider()
{
	if (!Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.InnerSingleton, Z_Construct_UEnum_PlayFab_ESegmentLoginIdentityProvider_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider.InnerSingleton;
}
// End Enum ESegmentLoginIdentityProvider

// Begin Enum ESegmentPushNotificationDevicePlatform
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform;
static UEnum* ESegmentPushNotificationDevicePlatform_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESegmentPushNotificationDevicePlatform"));
	}
	return Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.OuterSingleton;
}
...
struct Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESegmentPushNotificationDevicePlatform",
	"ESegmentPushNotificationDevicePlatform",
	Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform()
{
	if (!Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.InnerSingleton, Z_Construct_UEnum_PlayFab_ESegmentPushNotificationDevicePlatform_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform.InnerSingleton;
}
// End Enum ESegmentPushNotificationDevicePlatform

// Begin Enum EPfSourceType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPfSourceType;
static UEnum* EPfSourceType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPfSourceType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPfSourceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPfSourceType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPfSourceType"));
	}
	return Z_Registration_Info_UEnum_EPfSourceType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPfSourceType>()
{
	return EPfSourceType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPfSourceType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPfSourceType",
	"EPfSourceType",
	Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPfSourceType()
{
	if (!Z_Registration_Info_UEnum_EPfSourceType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPfSourceType.InnerSingleton, Z_Construct_UEnum_PlayFab_EPfSourceType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPfSourceType.InnerSingleton;
}
// End Enum EPfSourceType

// Begin Enum EStatisticAggregationMethod
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EStatisticAggregationMethod;
static UEnum* EStatisticAggregationMethod_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EStatisticAggregationMethod.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EStatisticAggregationMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EStatisticAggregationMethod"));
	}
	return Z_Registration_Info_UEnum_EStatisticAggregationMethod.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EStatisticAggregationMethod>()
{
	return EStatisticAggregationMethod_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EStatisticAggregationMethod",
	"EStatisticAggregationMethod",
	Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod()
{
	if (!Z_Registration_Info_UEnum_EStatisticAggregationMethod.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStatisticAggregationMethod.InnerSingleton, Z_Construct_UEnum_PlayFab_EStatisticAggregationMethod_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EStatisticAggregationMethod.InnerSingleton;
}
// End Enum EStatisticAggregationMethod

// Begin Enum EStatisticResetIntervalOption
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EStatisticResetIntervalOption;
static UEnum* EStatisticResetIntervalOption_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EStatisticResetIntervalOption.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EStatisticResetIntervalOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EStatisticResetIntervalOption"));
	}
	return Z_Registration_Info_UEnum_EStatisticResetIntervalOption.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EStatisticResetIntervalOption>()
{
	return EStatisticResetIntervalOption_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EStatisticResetIntervalOption",
	"EStatisticResetIntervalOption",
	Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption()
{
	if (!Z_Registration_Info_UEnum_EStatisticResetIntervalOption.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStatisticResetIntervalOption.InnerSingleton, Z_Construct_UEnum_PlayFab_EStatisticResetIntervalOption_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EStatisticResetIntervalOption.InnerSingleton;
}
// End Enum EStatisticResetIntervalOption

// Begin Enum EStatisticVersionArchivalStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus;
static UEnum* EStatisticVersionArchivalStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EStatisticVersionArchivalStatus"));
	}
	return Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EStatisticVersionArchivalStatus>()
{
	return EStatisticVersionArchivalStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EStatisticVersionArchivalStatus",
	"EStatisticVersionArchivalStatus",
	Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus()
{
	if (!Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_EStatisticVersionArchivalStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus.InnerSingleton;
}
// End Enum EStatisticVersionArchivalStatus

// Begin Enum EStatisticVersionStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EStatisticVersionStatus;
static UEnum* EStatisticVersionStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EStatisticVersionStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EStatisticVersionStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EStatisticVersionStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EStatisticVersionStatus"));
	}
	return Z_Registration_Info_UEnum_EStatisticVersionStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EStatisticVersionStatus>()
{
	return EStatisticVersionStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EStatisticVersionStatus",
	"EStatisticVersionStatus",
	Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EStatisticVersionStatus()
{
	if (!Z_Registration_Info_UEnum_EStatisticVersionStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EStatisticVersionStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_EStatisticVersionStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EStatisticVersionStatus.InnerSingleton;
}
// End Enum EStatisticVersionStatus

// Begin Enum ESubscriptionProviderStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESubscriptionProviderStatus;
static UEnum* ESubscriptionProviderStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESubscriptionProviderStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESubscriptionProviderStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESubscriptionProviderStatus"));
	}
	return Z_Registration_Info_UEnum_ESubscriptionProviderStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESubscriptionProviderStatus>()
{
	return ESubscriptionProviderStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESubscriptionProviderStatus",
	"ESubscriptionProviderStatus",
	Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus()
{
	if (!Z_Registration_Info_UEnum_ESubscriptionProviderStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESubscriptionProviderStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ESubscriptionProviderStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESubscriptionProviderStatus.InnerSingleton;
}
// End Enum ESubscriptionProviderStatus

// Begin Enum ETaskInstanceStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ETaskInstanceStatus;
static UEnum* ETaskInstanceStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ETaskInstanceStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ETaskInstanceStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ETaskInstanceStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ETaskInstanceStatus"));
	}
	return Z_Registration_Info_UEnum_ETaskInstanceStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ETaskInstanceStatus>()
{
	return ETaskInstanceStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ETaskInstanceStatus",
	"ETaskInstanceStatus",
	Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ETaskInstanceStatus()
{
	if (!Z_Registration_Info_UEnum_ETaskInstanceStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ETaskInstanceStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ETaskInstanceStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ETaskInstanceStatus.InnerSingleton;
}
// End Enum ETaskInstanceStatus

// Begin Enum ETitleActivationStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ETitleActivationStatus;
static UEnum* ETitleActivationStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ETitleActivationStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ETitleActivationStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ETitleActivationStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ETitleActivationStatus"));
	}
	return Z_Registration_Info_UEnum_ETitleActivationStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ETitleActivationStatus>()
{
	return ETitleActivationStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ETitleActivationStatus",
	"ETitleActivationStatus",
	Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ETitleActivationStatus()
{
	if (!Z_Registration_Info_UEnum_ETitleActivationStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ETitleActivationStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ETitleActivationStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ETitleActivationStatus.InnerSingleton;
}
// End Enum ETitleActivationStatus

// Begin Enum EUserDataPermission
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EUserDataPermission;
static UEnum* EUserDataPermission_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EUserDataPermission.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EUserDataPermission.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EUserDataPermission, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EUserDataPermission"));
	}
	return Z_Registration_Info_UEnum_EUserDataPermission.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EUserDataPermission>()
{
	return EUserDataPermission_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EUserDataPermission",
	"EUserDataPermission",
	Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EUserDataPermission()
{
	if (!Z_Registration_Info_UEnum_EUserDataPermission.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EUserDataPermission.InnerSingleton, Z_Construct_UEnum_PlayFab_EUserDataPermission_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EUserDataPermission.InnerSingleton;
}
// End Enum EUserDataPermission

// Begin Enum EUserFamilyType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EUserFamilyType;
static UEnum* EUserFamilyType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EUserFamilyType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EUserFamilyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EUserFamilyType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EUserFamilyType"));
	}
	return Z_Registration_Info_UEnum_EUserFamilyType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EUserFamilyType>()
{
	return EUserFamilyType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** UserFamilyType */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EUserFamilyType::pfenum_None" },
		{ "pfenum_Steam.DisplayName", "Steam" },
		{ "pfenum_Steam.Name", "EUserFamilyType::pfenum_Steam" },
		{ "pfenum_Xbox.DisplayName", "Xbox" },
		{ "pfenum_Xbox.Name", "EUserFamilyType::pfenum_Xbox" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "UserFamilyType" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EUserFamilyType::pfenum_None", (int64)EUserFamilyType::pfenum_None },
		{ "EUserFamilyType::pfenum_Xbox", (int64)EUserFamilyType::pfenum_Xbox },
		{ "EUserFamilyType::pfenum_Steam", (int64)EUserFamilyType::pfenum_Steam },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EUserFamilyType",
	"EUserFamilyType",
	Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EUserFamilyType()
{
	if (!Z_Registration_Info_UEnum_EUserFamilyType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EUserFamilyType.InnerSingleton, Z_Construct_UEnum_PlayFab_EUserFamilyType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EUserFamilyType.InnerSingleton;
}
// End Enum EUserFamilyType

// Begin Enum EUserOrigination
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EUserOrigination;
static UEnum* EUserOrigination_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EUserOrigination.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EUserOrigination.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EUserOrigination, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EUserOrigination"));
	}
	return Z_Registration_Info_UEnum_EUserOrigination.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EUserOrigination>()
{
	return EUserOrigination_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EUserOrigination_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_GooglePlayGames.DisplayName", "GooglePlayGames" },
		{ "pfenum_GooglePlayGames.Name", "EUserOrigination::pfenum_GooglePlayGames" },
		{ "pfenum_IOS.DisplayName", "IOS" },
		{ "pfenum_IOS.Name", "EUserOrigination::pfenum_IOS" },
		{ "pfenum_King.DisplayName", "King" },
		{ "pfenum_King.Name", "EUserOrigination::pfenum_King" },
		{ "pfenum_Kongregate.DisplayName", "Kongregate" },
		...
		{ "pfenum_XboxMobileStore.DisplayName", "XboxMobileStore" },
		{ "pfenum_XboxMobileStore.Name", "EUserOrigination::pfenum_XboxMobileStore" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EUserOrigination::pfenum_GooglePlayGames", (int64)EUserOrigination::pfenum_GooglePlayGames },
		{ "EUserOrigination::pfenum_XboxMobileStore", (int64)EUserOrigination::pfenum_XboxMobileStore },
		{ "EUserOrigination::pfenum_King", (int64)EUserOrigination::pfenum_King },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EUserOrigination",
	"EUserOrigination",
	Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EUserOrigination()
{
	if (!Z_Registration_Info_UEnum_EUserOrigination.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EUserOrigination.InnerSingleton, Z_Construct_UEnum_PlayFab_EUserOrigination_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EUserOrigination.InnerSingleton;
}
// End Enum EUserOrigination

// Begin Enum EAdActivity
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAdActivity;
static UEnum* EAdActivity_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAdActivity.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAdActivity.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAdActivity, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAdActivity"));
	}
	return Z_Registration_Info_UEnum_EAdActivity.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAdActivity>()
{
	return EAdActivity_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAdActivity_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAdActivity_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAdActivity",
	"EAdActivity",
	Z_Construct_UEnum_PlayFab_EAdActivity_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAdActivity_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAdActivity_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAdActivity_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAdActivity()
{
	if (!Z_Registration_Info_UEnum_EAdActivity.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAdActivity.InnerSingleton, Z_Construct_UEnum_PlayFab_EAdActivity_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAdActivity.InnerSingleton;
}
// End Enum EAdActivity

// Begin Enum ECloudScriptRevisionOption
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ECloudScriptRevisionOption;
static UEnum* ECloudScriptRevisionOption_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ECloudScriptRevisionOption.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ECloudScriptRevisionOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ECloudScriptRevisionOption"));
	}
	return Z_Registration_Info_UEnum_ECloudScriptRevisionOption.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ECloudScriptRevisionOption>()
{
	return ECloudScriptRevisionOption_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ECloudScriptRevisionOption",
	"ECloudScriptRevisionOption",
	Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption()
{
	if (!Z_Registration_Info_UEnum_ECloudScriptRevisionOption.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECloudScriptRevisionOption.InnerSingleton, Z_Construct_UEnum_PlayFab_ECloudScriptRevisionOption_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ECloudScriptRevisionOption.InnerSingleton;
}
// End Enum ECloudScriptRevisionOption

// Begin Enum EExternalFriendSources
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EExternalFriendSources;
static UEnum* EExternalFriendSources_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EExternalFriendSources.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EExternalFriendSources.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EExternalFriendSources, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EExternalFriendSources"));
	}
	return Z_Registration_Info_UEnum_EExternalFriendSources.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EExternalFriendSources>()
{
	return EExternalFriendSources_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** ExternalFriendSources */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_All.DisplayName", "All" },
		{ "pfenum_All.Name", "EExternalFriendSources::pfenum_All" },
		{ "pfenum_Facebook.DisplayName", "Facebook" },
		{ "pfenum_Facebook.Name", "EExternalFriendSources::pfenum_Facebook" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EExternalFriendSources::pfenum_None" },
		{ "pfenum_Psn.DisplayName", "Psn" },
		{ "pfenum_Psn.Name", "EExternalFriendSources::pfenum_Psn" },
		{ "pfenum_Steam.DisplayName", "Steam" },
		{ "pfenum_Steam.Name", "EExternalFriendSources::pfenum_Steam" },
		{ "pfenum_Xbox.DisplayName", "Xbox" },
		{ "pfenum_Xbox.Name", "EExternalFriendSources::pfenum_Xbox" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "ExternalFriendSources" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EExternalFriendSources::pfenum_None", (int64)EExternalFriendSources::pfenum_None },
		{ "EExternalFriendSources::pfenum_Steam", (int64)EExternalFriendSources::pfenum_Steam },
		{ "EExternalFriendSources::pfenum_Facebook", (int64)EExternalFriendSources::pfenum_Facebook },
		{ "EExternalFriendSources::pfenum_Xbox", (int64)EExternalFriendSources::pfenum_Xbox },
		{ "EExternalFriendSources::pfenum_Psn", (int64)EExternalFriendSources::pfenum_Psn },
		{ "EExternalFriendSources::pfenum_All", (int64)EExternalFriendSources::pfenum_All },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EExternalFriendSources",
	"EExternalFriendSources",
	Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EExternalFriendSources()
{
	if (!Z_Registration_Info_UEnum_EExternalFriendSources.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EExternalFriendSources.InnerSingleton, Z_Construct_UEnum_PlayFab_EExternalFriendSources_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EExternalFriendSources.InnerSingleton;
}
// End Enum EExternalFriendSources

// Begin Enum ETradeStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ETradeStatus;
static UEnum* ETradeStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ETradeStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ETradeStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ETradeStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ETradeStatus"));
	}
	return Z_Registration_Info_UEnum_ETradeStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ETradeStatus>()
{
	return ETradeStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ETradeStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ETradeStatus",
	"ETradeStatus",
	Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ETradeStatus()
{
	if (!Z_Registration_Info_UEnum_ETradeStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ETradeStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ETradeStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ETradeStatus.InnerSingleton;
}
// End Enum ETradeStatus

// Begin Enum ETransactionStatus
...
static UEnum* ETransactionStatus_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ETransactionStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ETransactionStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ETransactionStatus"));
	}
...
struct Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ETransactionStatus",
	"ETransactionStatus",
	Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ETransactionStatus()
{
	if (!Z_Registration_Info_UEnum_ETransactionStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ETransactionStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ETransactionStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ETransactionStatus.InnerSingleton;
}
// End Enum ETransactionStatus

// Begin Enum EIdentifiedDeviceType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EIdentifiedDeviceType;
static UEnum* EIdentifiedDeviceType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EIdentifiedDeviceType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EIdentifiedDeviceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EIdentifiedDeviceType"));
	}
	return Z_Registration_Info_UEnum_EIdentifiedDeviceType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EIdentifiedDeviceType>()
{
	return EIdentifiedDeviceType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_android.DisplayName", "android" },
		{ "pfenum_android.Name", "EIdentifiedDeviceType::pfenum_android" },
		{ "pfenum_iOS.DisplayName", "iOS" },
		{ "pfenum_iOS.Name", "EIdentifiedDeviceType::pfenum_iOS" },
		{ "pfenum_Nintendo.DisplayName", "Nintendo" },
		{ "pfenum_Nintendo.Name", "EIdentifiedDeviceType::pfenum_Nintendo" },
		{ "pfenum_PlayStation.DisplayName", "PlayStation" },
		{ "pfenum_PlayStation.Name", "EIdentifiedDeviceType::pfenum_PlayStation" },
		...
		{ "pfenum_Win32.DisplayName", "Win32" },
		{ "pfenum_Win32.Name", "EIdentifiedDeviceType::pfenum_Win32" },
		{ "pfenum_WindowsOneCore.DisplayName", "WindowsOneCore" },
		{ "pfenum_WindowsOneCore.Name", "EIdentifiedDeviceType::pfenum_WindowsOneCore" },
		{ "pfenum_WindowsOneCoreMobile.DisplayName", "WindowsOneCoreMobile" },
		{ "pfenum_WindowsOneCoreMobile.Name", "EIdentifiedDeviceType::pfenum_WindowsOneCoreMobile" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EIdentifiedDeviceType::pfenum_WindowsOneCore", (int64)EIdentifiedDeviceType::pfenum_WindowsOneCore },
		{ "EIdentifiedDeviceType::pfenum_WindowsOneCoreMobile", (int64)EIdentifiedDeviceType::pfenum_WindowsOneCoreMobile },
		{ "EIdentifiedDeviceType::pfenum_Win32", (int64)EIdentifiedDeviceType::pfenum_Win32 },
		{ "EIdentifiedDeviceType::pfenum_android", (int64)EIdentifiedDeviceType::pfenum_android },
		{ "EIdentifiedDeviceType::pfenum_iOS", (int64)EIdentifiedDeviceType::pfenum_iOS },
		{ "EIdentifiedDeviceType::pfenum_PlayStation", (int64)EIdentifiedDeviceType::pfenum_PlayStation },
		{ "EIdentifiedDeviceType::pfenum_Nintendo", (int64)EIdentifiedDeviceType::pfenum_Nintendo },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EIdentifiedDeviceType",
	"EIdentifiedDeviceType",
	Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType()
{
	if (!Z_Registration_Info_UEnum_EIdentifiedDeviceType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EIdentifiedDeviceType.InnerSingleton, Z_Construct_UEnum_PlayFab_EIdentifiedDeviceType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EIdentifiedDeviceType.InnerSingleton;
}
// End Enum EIdentifiedDeviceType

// Begin Enum EPfTriggerType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPfTriggerType;
static UEnum* EPfTriggerType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPfTriggerType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPfTriggerType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPfTriggerType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPfTriggerType"));
	}
	return Z_Registration_Info_UEnum_EPfTriggerType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPfTriggerType>()
{
	return EPfTriggerType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_EventHub.DisplayName", "EventHub" },
		{ "pfenum_EventHub.Name", "EPfTriggerType::pfenum_EventHub" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EPfTriggerType::pfenum_EventHub", (int64)EPfTriggerType::pfenum_EventHub },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPfTriggerType",
	"EPfTriggerType",
	Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPfTriggerType()
{
	if (!Z_Registration_Info_UEnum_EPfTriggerType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPfTriggerType.InnerSingleton, Z_Construct_UEnum_PlayFab_EPfTriggerType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPfTriggerType.InnerSingleton;
}
// End Enum EPfTriggerType

// Begin Enum EOperationTypes
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EOperationTypes;
static UEnum* EOperationTypes_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EOperationTypes.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EOperationTypes.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EOperationTypes, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EOperationTypes"));
	}
	return Z_Registration_Info_UEnum_EOperationTypes.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EOperationTypes>()
{
	return EOperationTypes_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EOperationTypes_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EOperationTypes",
	"EOperationTypes",
	Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EOperationTypes()
{
	if (!Z_Registration_Info_UEnum_EOperationTypes.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EOperationTypes.InnerSingleton, Z_Construct_UEnum_PlayFab_EOperationTypes_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EOperationTypes.InnerSingleton;
}
// End Enum EOperationTypes

// Begin Enum EConcernCategory
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EConcernCategory;
static UEnum* EConcernCategory_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EConcernCategory.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EConcernCategory.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EConcernCategory, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EConcernCategory"));
	}
	return Z_Registration_Info_UEnum_EConcernCategory.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EConcernCategory>()
{
	return EConcernCategory_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EConcernCategory_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** ConcernCategory */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_ChildExploitation.DisplayName", "ChildExploitation" },
		{ "pfenum_ChildExploitation.Name", "EConcernCategory::pfenum_ChildExploitation" },
		{ "pfenum_MalwareOrVirus.DisplayName", "MalwareOrVirus" },
		{ "pfenum_MalwareOrVirus.Name", "EConcernCategory::pfenum_MalwareOrVirus" },
		{ "pfenum_MisleadingApp.DisplayName", "MisleadingApp" },
		{ "pfenum_MisleadingApp.Name", "EConcernCategory::pfenum_MisleadingApp" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EConcernCategory::pfenum_None" },
		{ "pfenum_OffensiveContent.DisplayName", "OffensiveContent" },
		{ "pfenum_OffensiveContent.Name", "EConcernCategory::pfenum_OffensiveContent" },
		{ "pfenum_PoorPerformance.DisplayName", "PoorPerformance" },
		{ "pfenum_PoorPerformance.Name", "EConcernCategory::pfenum_PoorPerformance" },
		{ "pfenum_PrivacyConcerns.DisplayName", "PrivacyConcerns" },
		{ "pfenum_PrivacyConcerns.Name", "EConcernCategory::pfenum_PrivacyConcerns" },
		{ "pfenum_Profanity.DisplayName", "Profanity" },
		{ "pfenum_Profanity.Name", "EConcernCategory::pfenum_Profanity" },
		{ "pfenum_ReviewResponse.DisplayName", "ReviewResponse" },
		{ "pfenum_ReviewResponse.Name", "EConcernCategory::pfenum_ReviewResponse" },
		{ "pfenum_SpamAdvertising.DisplayName", "SpamAdvertising" },
		{ "pfenum_SpamAdvertising.Name", "EConcernCategory::pfenum_SpamAdvertising" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "ConcernCategory" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EConcernCategory::pfenum_None", (int64)EConcernCategory::pfenum_None },
		{ "EConcernCategory::pfenum_OffensiveContent", (int64)EConcernCategory::pfenum_OffensiveContent },
		{ "EConcernCategory::pfenum_ChildExploitation", (int64)EConcernCategory::pfenum_ChildExploitation },
		{ "EConcernCategory::pfenum_MalwareOrVirus", (int64)EConcernCategory::pfenum_MalwareOrVirus },
		{ "EConcernCategory::pfenum_PrivacyConcerns", (int64)EConcernCategory::pfenum_PrivacyConcerns },
		{ "EConcernCategory::pfenum_MisleadingApp", (int64)EConcernCategory::pfenum_MisleadingApp },
		{ "EConcernCategory::pfenum_PoorPerformance", (int64)EConcernCategory::pfenum_PoorPerformance },
		{ "EConcernCategory::pfenum_ReviewResponse", (int64)EConcernCategory::pfenum_ReviewResponse },
		{ "EConcernCategory::pfenum_SpamAdvertising", (int64)EConcernCategory::pfenum_SpamAdvertising },
		{ "EConcernCategory::pfenum_Profanity", (int64)EConcernCategory::pfenum_Profanity },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EConcernCategory",
	"EConcernCategory",
	Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EConcernCategory()
{
	if (!Z_Registration_Info_UEnum_EConcernCategory.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EConcernCategory.InnerSingleton, Z_Construct_UEnum_PlayFab_EConcernCategory_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EConcernCategory.InnerSingleton;
}
// End Enum EConcernCategory

// Begin Enum EDisplayPropertyType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EDisplayPropertyType;
static UEnum* EDisplayPropertyType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EDisplayPropertyType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EDisplayPropertyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EDisplayPropertyType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EDisplayPropertyType"));
	}
	return Z_Registration_Info_UEnum_EDisplayPropertyType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EDisplayPropertyType>()
{
	return EDisplayPropertyType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** DisplayPropertyType */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EDisplayPropertyType::pfenum_None" },
		{ "pfenum_QueryDateTime.DisplayName", "QueryDateTime" },
		{ "pfenum_QueryDateTime.Name", "EDisplayPropertyType::pfenum_QueryDateTime" },
		{ "pfenum_QueryDouble.DisplayName", "QueryDouble" },
		{ "pfenum_QueryDouble.Name", "EDisplayPropertyType::pfenum_QueryDouble" },
		{ "pfenum_QueryString.DisplayName", "QueryString" },
		{ "pfenum_QueryString.Name", "EDisplayPropertyType::pfenum_QueryString" },
		{ "pfenum_SearchString.DisplayName", "SearchString" },
		{ "pfenum_SearchString.Name", "EDisplayPropertyType::pfenum_SearchString" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "DisplayPropertyType" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EDisplayPropertyType::pfenum_None", (int64)EDisplayPropertyType::pfenum_None },
		{ "EDisplayPropertyType::pfenum_QueryDateTime", (int64)EDisplayPropertyType::pfenum_QueryDateTime },
		{ "EDisplayPropertyType::pfenum_QueryDouble", (int64)EDisplayPropertyType::pfenum_QueryDouble },
		{ "EDisplayPropertyType::pfenum_QueryString", (int64)EDisplayPropertyType::pfenum_QueryString },
		{ "EDisplayPropertyType::pfenum_SearchString", (int64)EDisplayPropertyType::pfenum_SearchString },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EDisplayPropertyType",
	"EDisplayPropertyType",
	Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EDisplayPropertyType()
{
	if (!Z_Registration_Info_UEnum_EDisplayPropertyType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EDisplayPropertyType.InnerSingleton, Z_Construct_UEnum_PlayFab_EDisplayPropertyType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EDisplayPropertyType.InnerSingleton;
}
// End Enum EDisplayPropertyType

// Begin Enum EHelpfulnessVote
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EHelpfulnessVote;
static UEnum* EHelpfulnessVote_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EHelpfulnessVote.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EHelpfulnessVote.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EHelpfulnessVote, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EHelpfulnessVote"));
	}
	return Z_Registration_Info_UEnum_EHelpfulnessVote.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EHelpfulnessVote>()
{
	return EHelpfulnessVote_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** HelpfulnessVote */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Helpful.DisplayName", "Helpful" },
		{ "pfenum_Helpful.Name", "EHelpfulnessVote::pfenum_Helpful" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EHelpfulnessVote::pfenum_None" },
		{ "pfenum_UnHelpful.DisplayName", "UnHelpful" },
		{ "pfenum_UnHelpful.Name", "EHelpfulnessVote::pfenum_UnHelpful" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "HelpfulnessVote" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EHelpfulnessVote::pfenum_None", (int64)EHelpfulnessVote::pfenum_None },
		{ "EHelpfulnessVote::pfenum_UnHelpful", (int64)EHelpfulnessVote::pfenum_UnHelpful },
		{ "EHelpfulnessVote::pfenum_Helpful", (int64)EHelpfulnessVote::pfenum_Helpful },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EHelpfulnessVote",
	"EHelpfulnessVote",
	Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EHelpfulnessVote()
{
	if (!Z_Registration_Info_UEnum_EHelpfulnessVote.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EHelpfulnessVote.InnerSingleton, Z_Construct_UEnum_PlayFab_EHelpfulnessVote_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EHelpfulnessVote.InnerSingleton;
}
// End Enum EHelpfulnessVote

// Begin Enum EModerationStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EModerationStatus;
static UEnum* EModerationStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EModerationStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EModerationStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EModerationStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EModerationStatus"));
	}
	return Z_Registration_Info_UEnum_EModerationStatus.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EModerationStatus>()
{
	return EModerationStatus_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EModerationStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Approved.DisplayName", "Approved" },
		{ "pfenum_Approved.Name", "EModerationStatus::pfenum_Approved" },
		{ "pfenum_AwaitingModeration.DisplayName", "AwaitingModeration" },
		{ "pfenum_AwaitingModeration.Name", "EModerationStatus::pfenum_AwaitingModeration" },
		{ "pfenum_Rejected.DisplayName", "Rejected" },
		{ "pfenum_Rejected.Name", "EModerationStatus::pfenum_Rejected" },
		{ "pfenum_Unknown.DisplayName", "Unknown" },
		{ "pfenum_Unknown.Name", "EModerationStatus::pfenum_Unknown" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "ModerationStatus" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EModerationStatus::pfenum_Unknown", (int64)EModerationStatus::pfenum_Unknown },
		{ "EModerationStatus::pfenum_AwaitingModeration", (int64)EModerationStatus::pfenum_AwaitingModeration },
		{ "EModerationStatus::pfenum_Approved", (int64)EModerationStatus::pfenum_Approved },
		{ "EModerationStatus::pfenum_Rejected", (int64)EModerationStatus::pfenum_Rejected },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EModerationStatus",
	"EModerationStatus",
	Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EModerationStatus()
{
	if (!Z_Registration_Info_UEnum_EModerationStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EModerationStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_EModerationStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EModerationStatus.InnerSingleton;
}
// End Enum EModerationStatus

// Begin Enum EPublishResult
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPublishResult;
static UEnum* EPublishResult_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPublishResult.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPublishResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPublishResult, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPublishResult"));
	}
	return Z_Registration_Info_UEnum_EPublishResult.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPublishResult>()
{
	return EPublishResult_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPublishResult_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** PublishResult */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Canceled.DisplayName", "Canceled" },
		{ "pfenum_Canceled.Name", "EPublishResult::pfenum_Canceled" },
		{ "pfenum_Failed.DisplayName", "Failed" },
		{ "pfenum_Failed.Name", "EPublishResult::pfenum_Failed" },
		{ "pfenum_Pending.DisplayName", "Pending" },
		{ "pfenum_Pending.Name", "EPublishResult::pfenum_Pending" },
		{ "pfenum_Succeeded.DisplayName", "Succeeded" },
		{ "pfenum_Succeeded.Name", "EPublishResult::pfenum_Succeeded" },
		{ "pfenum_Unknown.DisplayName", "Unknown" },
		{ "pfenum_Unknown.Name", "EPublishResult::pfenum_Unknown" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "PublishResult" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EPublishResult::pfenum_Unknown", (int64)EPublishResult::pfenum_Unknown },
		{ "EPublishResult::pfenum_Pending", (int64)EPublishResult::pfenum_Pending },
		{ "EPublishResult::pfenum_Succeeded", (int64)EPublishResult::pfenum_Succeeded },
		{ "EPublishResult::pfenum_Failed", (int64)EPublishResult::pfenum_Failed },
		{ "EPublishResult::pfenum_Canceled", (int64)EPublishResult::pfenum_Canceled },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPublishResult_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPublishResult",
	"EPublishResult",
	Z_Construct_UEnum_PlayFab_EPublishResult_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPublishResult_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPublishResult_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPublishResult_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPublishResult()
{
	if (!Z_Registration_Info_UEnum_EPublishResult.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPublishResult.InnerSingleton, Z_Construct_UEnum_PlayFab_EPublishResult_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPublishResult.InnerSingleton;
}
// End Enum EPublishResult

// Begin Enum EAnalysisTaskState
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAnalysisTaskState;
static UEnum* EAnalysisTaskState_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAnalysisTaskState.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAnalysisTaskState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAnalysisTaskState, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAnalysisTaskState"));
	}
	return Z_Registration_Info_UEnum_EAnalysisTaskState.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAnalysisTaskState>()
{
	return EAnalysisTaskState_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAnalysisTaskState",
	"EAnalysisTaskState",
	Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAnalysisTaskState()
{
	if (!Z_Registration_Info_UEnum_EAnalysisTaskState.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAnalysisTaskState.InnerSingleton, Z_Construct_UEnum_PlayFab_EAnalysisTaskState_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAnalysisTaskState.InnerSingleton;
}
// End Enum EAnalysisTaskState

// Begin Enum EExperimentState
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EExperimentState;
static UEnum* EExperimentState_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EExperimentState.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EExperimentState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EExperimentState, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EExperimentState"));
	}
	return Z_Registration_Info_UEnum_EExperimentState.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EExperimentState>()
{
	return EExperimentState_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EExperimentState_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EExperimentState_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EExperimentState",
	"EExperimentState",
	Z_Construct_UEnum_PlayFab_EExperimentState_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExperimentState_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExperimentState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EExperimentState_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EExperimentState()
{
	if (!Z_Registration_Info_UEnum_EExperimentState.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EExperimentState.InnerSingleton, Z_Construct_UEnum_PlayFab_EExperimentState_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EExperimentState.InnerSingleton;
}
// End Enum EExperimentState

// Begin Enum EExperimentType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EExperimentType;
static UEnum* EExperimentType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EExperimentType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EExperimentType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EExperimentType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EExperimentType"));
	}
	return Z_Registration_Info_UEnum_EExperimentType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EExperimentType>()
{
	return EExperimentType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EExperimentType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EExperimentType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EExperimentType",
	"EExperimentType",
	Z_Construct_UEnum_PlayFab_EExperimentType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExperimentType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EExperimentType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EExperimentType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EExperimentType()
{
	if (!Z_Registration_Info_UEnum_EExperimentType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EExperimentType.InnerSingleton, Z_Construct_UEnum_PlayFab_EExperimentType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EExperimentType.InnerSingleton;
}
// End Enum EExperimentType

// Begin Enum ELeaderboardSortDirection
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ELeaderboardSortDirection;
static UEnum* ELeaderboardSortDirection_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ELeaderboardSortDirection.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ELeaderboardSortDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ELeaderboardSortDirection"));
	}
	return Z_Registration_Info_UEnum_ELeaderboardSortDirection.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ELeaderboardSortDirection>()
{
	return ELeaderboardSortDirection_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** LeaderboardSortDirection */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Ascending.DisplayName", "Ascending" },
		{ "pfenum_Ascending.Name", "ELeaderboardSortDirection::pfenum_Ascending" },
		{ "pfenum_Descending.DisplayName", "Descending" },
		{ "pfenum_Descending.Name", "ELeaderboardSortDirection::pfenum_Descending" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "LeaderboardSortDirection" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "ELeaderboardSortDirection::pfenum_Descending", (int64)ELeaderboardSortDirection::pfenum_Descending },
		{ "ELeaderboardSortDirection::pfenum_Ascending", (int64)ELeaderboardSortDirection::pfenum_Ascending },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ELeaderboardSortDirection",
	"ELeaderboardSortDirection",
	Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection()
{
	if (!Z_Registration_Info_UEnum_ELeaderboardSortDirection.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELeaderboardSortDirection.InnerSingleton, Z_Construct_UEnum_PlayFab_ELeaderboardSortDirection_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ELeaderboardSortDirection.InnerSingleton;
}
// End Enum ELeaderboardSortDirection

// Begin Enum EResetInterval
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EResetInterval;
static UEnum* EResetInterval_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EResetInterval.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EResetInterval.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EResetInterval, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EResetInterval"));
	}
	return Z_Registration_Info_UEnum_EResetInterval.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EResetInterval>()
{
	return EResetInterval_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EResetInterval_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** ResetInterval */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Day.DisplayName", "Day" },
		{ "pfenum_Day.Name", "EResetInterval::pfenum_Day" },
		{ "pfenum_Hour.DisplayName", "Hour" },
		{ "pfenum_Hour.Name", "EResetInterval::pfenum_Hour" },
		{ "pfenum_Manual.DisplayName", "Manual" },
		{ "pfenum_Manual.Name", "EResetInterval::pfenum_Manual" },
		{ "pfenum_Month.DisplayName", "Month" },
		{ "pfenum_Month.Name", "EResetInterval::pfenum_Month" },
		{ "pfenum_Week.DisplayName", "Week" },
		{ "pfenum_Week.Name", "EResetInterval::pfenum_Week" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "ResetInterval" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EResetInterval::pfenum_Manual", (int64)EResetInterval::pfenum_Manual },
		{ "EResetInterval::pfenum_Hour", (int64)EResetInterval::pfenum_Hour },
		{ "EResetInterval::pfenum_Day", (int64)EResetInterval::pfenum_Day },
		{ "EResetInterval::pfenum_Week", (int64)EResetInterval::pfenum_Week },
		{ "EResetInterval::pfenum_Month", (int64)EResetInterval::pfenum_Month },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EResetInterval_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EResetInterval",
	"EResetInterval",
	Z_Construct_UEnum_PlayFab_EResetInterval_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResetInterval_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EResetInterval_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EResetInterval_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EResetInterval()
{
	if (!Z_Registration_Info_UEnum_EResetInterval.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EResetInterval.InnerSingleton, Z_Construct_UEnum_PlayFab_EResetInterval_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EResetInterval.InnerSingleton;
}
// End Enum EResetInterval

// Begin Enum EAccessPolicy
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAccessPolicy;
static UEnum* EAccessPolicy_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAccessPolicy.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAccessPolicy.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAccessPolicy, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAccessPolicy"));
	}
	return Z_Registration_Info_UEnum_EAccessPolicy.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAccessPolicy>()
{
	return EAccessPolicy_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** AccessPolicy */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Friends.DisplayName", "Friends" },
		{ "pfenum_Friends.Name", "EAccessPolicy::pfenum_Friends" },
		{ "pfenum_Private.DisplayName", "Private" },
		{ "pfenum_Private.Name", "EAccessPolicy::pfenum_Private" },
		{ "pfenum_Public.DisplayName", "Public" },
		{ "pfenum_Public.Name", "EAccessPolicy::pfenum_Public" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "AccessPolicy" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EAccessPolicy::pfenum_Public", (int64)EAccessPolicy::pfenum_Public },
		{ "EAccessPolicy::pfenum_Friends", (int64)EAccessPolicy::pfenum_Friends },
		{ "EAccessPolicy::pfenum_Private", (int64)EAccessPolicy::pfenum_Private },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAccessPolicy",
	"EAccessPolicy",
	Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAccessPolicy()
{
	if (!Z_Registration_Info_UEnum_EAccessPolicy.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAccessPolicy.InnerSingleton, Z_Construct_UEnum_PlayFab_EAccessPolicy_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAccessPolicy.InnerSingleton;
}
// End Enum EAccessPolicy

// Begin Enum EAzureRegion
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAzureRegion;
static UEnum* EAzureRegion_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAzureRegion.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAzureRegion.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAzureRegion, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAzureRegion"));
	}
	return Z_Registration_Info_UEnum_EAzureRegion.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAzureRegion>()
{
	return EAzureRegion_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAzureRegion_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_SwedenCentral.DisplayName", "SwedenCentral" },
		{ "pfenum_SwedenCentral.Name", "EAzureRegion::pfenum_SwedenCentral" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EAzureRegion::pfenum_SwedenCentral", (int64)EAzureRegion::pfenum_SwedenCentral },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAzureRegion",
	"EAzureRegion",
	Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAzureRegion()
{
	if (!Z_Registration_Info_UEnum_EAzureRegion.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAzureRegion.InnerSingleton, Z_Construct_UEnum_PlayFab_EAzureRegion_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAzureRegion.InnerSingleton;
}
// End Enum EAzureRegion

// Begin Enum EAzureVmFamily
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAzureVmFamily;
static UEnum* EAzureVmFamily_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAzureVmFamily.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAzureVmFamily.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAzureVmFamily, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAzureVmFamily"));
	}
	return Z_Registration_Info_UEnum_EAzureVmFamily.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAzureVmFamily>()
{
	return EAzureVmFamily_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_Dadsv5.DisplayName", "Dadsv5" },
		{ "pfenum_Dadsv5.Name", "EAzureVmFamily::pfenum_Dadsv5" },
		...
		{ "pfenum_Ddsv5.DisplayName", "Ddsv5" },
		{ "pfenum_Ddsv5.Name", "EAzureVmFamily::pfenum_Ddsv5" },
		{ "pfenum_Ddv4.DisplayName", "Ddv4" },
		{ "pfenum_Ddv4.Name", "EAzureVmFamily::pfenum_Ddv4" },
		{ "pfenum_Ddv5.DisplayName", "Ddv5" },
		{ "pfenum_Ddv5.Name", "EAzureVmFamily::pfenum_Ddv5" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EAzureVmFamily::pfenum_Dadsv5", (int64)EAzureVmFamily::pfenum_Dadsv5 },
		...
		{ "EAzureVmFamily::pfenum_Ddv5", (int64)EAzureVmFamily::pfenum_Ddv5 },
		{ "EAzureVmFamily::pfenum_Ddsv5", (int64)EAzureVmFamily::pfenum_Ddsv5 },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAzureVmFamily",
	"EAzureVmFamily",
	Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAzureVmFamily()
{
	if (!Z_Registration_Info_UEnum_EAzureVmFamily.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAzureVmFamily.InnerSingleton, Z_Construct_UEnum_PlayFab_EAzureVmFamily_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAzureVmFamily.InnerSingleton;
}
// End Enum EAzureVmFamily

// Begin Enum EAzureVmSize
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAzureVmSize;
static UEnum* EAzureVmSize_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAzureVmSize.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAzureVmSize.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EAzureVmSize, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EAzureVmSize"));
	}
	return Z_Registration_Info_UEnum_EAzureVmSize.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EAzureVmSize>()
{
	return EAzureVmSize_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		...
		{ "pfenum_Standard_D16ads_v5.DisplayName", "Standard_D16ads_v5" },
		{ "pfenum_Standard_D16ads_v5.Name", "EAzureVmSize::pfenum_Standard_D16ads_v5" },
		...
		{ "pfenum_Standard_D16d_v5.DisplayName", "Standard_D16d_v5" },
		{ "pfenum_Standard_D16d_v5.Name", "EAzureVmSize::pfenum_Standard_D16d_v5" },
		...
		{ "pfenum_Standard_D16ds_v5.DisplayName", "Standard_D16ds_v5" },
		{ "pfenum_Standard_D16ds_v5.Name", "EAzureVmSize::pfenum_Standard_D16ds_v5" },
		...
		{ "pfenum_Standard_D2ads_v5.DisplayName", "Standard_D2ads_v5" },
		{ "pfenum_Standard_D2ads_v5.Name", "EAzureVmSize::pfenum_Standard_D2ads_v5" },
		...
		{ "pfenum_Standard_D2d_v5.DisplayName", "Standard_D2d_v5" },
		{ "pfenum_Standard_D2d_v5.Name", "EAzureVmSize::pfenum_Standard_D2d_v5" },
		{ "pfenum_Standard_D2ds_v4.DisplayName", "Standard_D2ds_v4" },
		{ "pfenum_Standard_D2ds_v4.Name", "EAzureVmSize::pfenum_Standard_D2ds_v4" },
		{ "pfenum_Standard_D2ds_v5.DisplayName", "Standard_D2ds_v5" },
		{ "pfenum_Standard_D2ds_v5.Name", "EAzureVmSize::pfenum_Standard_D2ds_v5" },
		{ "pfenum_Standard_D2s_v3.DisplayName", "Standard_D2s_v3" },
		{ "pfenum_Standard_D2s_v3.Name", "EAzureVmSize::pfenum_Standard_D2s_v3" },
		{ "pfenum_Standard_D32d_v5.DisplayName", "Standard_D32d_v5" },
		{ "pfenum_Standard_D32d_v5.Name", "EAzureVmSize::pfenum_Standard_D32d_v5" },
		{ "pfenum_Standard_D32ds_v5.DisplayName", "Standard_D32ds_v5" },
		{ "pfenum_Standard_D32ds_v5.Name", "EAzureVmSize::pfenum_Standard_D32ds_v5" },
		...
		{ "pfenum_Standard_D4ads_v5.DisplayName", "Standard_D4ads_v5" },
		{ "pfenum_Standard_D4ads_v5.Name", "EAzureVmSize::pfenum_Standard_D4ads_v5" },
		...
		{ "pfenum_Standard_D4d_v5.DisplayName", "Standard_D4d_v5" },
		{ "pfenum_Standard_D4d_v5.Name", "EAzureVmSize::pfenum_Standard_D4d_v5" },
		{ "pfenum_Standard_D4ds_v4.DisplayName", "Standard_D4ds_v4" },
		{ "pfenum_Standard_D4ds_v4.Name", "EAzureVmSize::pfenum_Standard_D4ds_v4" },
		{ "pfenum_Standard_D4ds_v5.DisplayName", "Standard_D4ds_v5" },
		{ "pfenum_Standard_D4ds_v5.Name", "EAzureVmSize::pfenum_Standard_D4ds_v5" },
		...
		{ "pfenum_Standard_D8ads_v5.DisplayName", "Standard_D8ads_v5" },
		{ "pfenum_Standard_D8ads_v5.Name", "EAzureVmSize::pfenum_Standard_D8ads_v5" },
		...
		{ "pfenum_Standard_D8d_v5.DisplayName", "Standard_D8d_v5" },
		{ "pfenum_Standard_D8d_v5.Name", "EAzureVmSize::pfenum_Standard_D8d_v5" },
		{ "pfenum_Standard_D8ds_v4.DisplayName", "Standard_D8ds_v4" },
		{ "pfenum_Standard_D8ds_v4.Name", "EAzureVmSize::pfenum_Standard_D8ds_v4" },
		{ "pfenum_Standard_D8ds_v5.DisplayName", "Standard_D8ds_v5" },
		{ "pfenum_Standard_D8ds_v5.Name", "EAzureVmSize::pfenum_Standard_D8ds_v5" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EAzureVmSize::pfenum_Standard_D2ads_v5", (int64)EAzureVmSize::pfenum_Standard_D2ads_v5 },
		{ "EAzureVmSize::pfenum_Standard_D4ads_v5", (int64)EAzureVmSize::pfenum_Standard_D4ads_v5 },
		{ "EAzureVmSize::pfenum_Standard_D8ads_v5", (int64)EAzureVmSize::pfenum_Standard_D8ads_v5 },
		{ "EAzureVmSize::pfenum_Standard_D16ads_v5", (int64)EAzureVmSize::pfenum_Standard_D16ads_v5 },
		...
		{ "EAzureVmSize::pfenum_Standard_D2d_v5", (int64)EAzureVmSize::pfenum_Standard_D2d_v5 },
		{ "EAzureVmSize::pfenum_Standard_D4d_v5", (int64)EAzureVmSize::pfenum_Standard_D4d_v5 },
		{ "EAzureVmSize::pfenum_Standard_D8d_v5", (int64)EAzureVmSize::pfenum_Standard_D8d_v5 },
		{ "EAzureVmSize::pfenum_Standard_D16d_v5", (int64)EAzureVmSize::pfenum_Standard_D16d_v5 },
		{ "EAzureVmSize::pfenum_Standard_D32d_v5", (int64)EAzureVmSize::pfenum_Standard_D32d_v5 },
		{ "EAzureVmSize::pfenum_Standard_D2ds_v5", (int64)EAzureVmSize::pfenum_Standard_D2ds_v5 },
		{ "EAzureVmSize::pfenum_Standard_D4ds_v5", (int64)EAzureVmSize::pfenum_Standard_D4ds_v5 },
		{ "EAzureVmSize::pfenum_Standard_D8ds_v5", (int64)EAzureVmSize::pfenum_Standard_D8ds_v5 },
		{ "EAzureVmSize::pfenum_Standard_D16ds_v5", (int64)EAzureVmSize::pfenum_Standard_D16ds_v5 },
		{ "EAzureVmSize::pfenum_Standard_D32ds_v5", (int64)EAzureVmSize::pfenum_Standard_D32ds_v5 },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EAzureVmSize",
	"EAzureVmSize",
	Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EAzureVmSize()
{
	if (!Z_Registration_Info_UEnum_EAzureVmSize.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAzureVmSize.InnerSingleton, Z_Construct_UEnum_PlayFab_EAzureVmSize_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAzureVmSize.InnerSingleton;
}
// End Enum EAzureVmSize

// Begin Enum ECancellationReason
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ECancellationReason;
static UEnum* ECancellationReason_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ECancellationReason.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ECancellationReason.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ECancellationReason, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ECancellationReason"));
	}
	return Z_Registration_Info_UEnum_ECancellationReason.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ECancellationReason>()
{
	return ECancellationReason_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ECancellationReason_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ECancellationReason",
	"ECancellationReason",
	Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ECancellationReason()
{
	if (!Z_Registration_Info_UEnum_ECancellationReason.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECancellationReason.InnerSingleton, Z_Construct_UEnum_PlayFab_ECancellationReason_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ECancellationReason.InnerSingleton;
}
// End Enum ECancellationReason

// Begin Enum EContainerFlavor
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EContainerFlavor;
static UEnum* EContainerFlavor_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EContainerFlavor.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EContainerFlavor.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EContainerFlavor, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EContainerFlavor"));
	}
	return Z_Registration_Info_UEnum_EContainerFlavor.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EContainerFlavor>()
{
	return EContainerFlavor_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EContainerFlavor",
	"EContainerFlavor",
	Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EContainerFlavor()
{
	if (!Z_Registration_Info_UEnum_EContainerFlavor.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EContainerFlavor.InnerSingleton, Z_Construct_UEnum_PlayFab_EContainerFlavor_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EContainerFlavor.InnerSingleton;
}
// End Enum EContainerFlavor

// Begin Enum EDirectPeerConnectivityOptions
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions;
static UEnum* EDirectPeerConnectivityOptions_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EDirectPeerConnectivityOptions"));
	}
	return Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EDirectPeerConnectivityOptions>()
{
	return EDirectPeerConnectivityOptions_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** DirectPeerConnectivityOptions */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_AnyEntityLoginProvider.DisplayName", "AnyEntityLoginProvider" },
		{ "pfenum_AnyEntityLoginProvider.Name", "EDirectPeerConnectivityOptions::pfenum_AnyEntityLoginProvider" },
		{ "pfenum_AnyPlatformType.DisplayName", "AnyPlatformType" },
		{ "pfenum_AnyPlatformType.Name", "EDirectPeerConnectivityOptions::pfenum_AnyPlatformType" },
		{ "pfenum_AnyPlatformTypeAndEntityLoginProvider.DisplayName", "AnyPlatformTypeAndEntityLoginProvider" },
		{ "pfenum_AnyPlatformTypeAndEntityLoginProvider.Name", "EDirectPeerConnectivityOptions::pfenum_AnyPlatformTypeAndEntityLoginProvider" },
		{ "pfenum_DifferentEntityLoginProvider.DisplayName", "DifferentEntityLoginProvider" },
		{ "pfenum_DifferentEntityLoginProvider.Name", "EDirectPeerConnectivityOptions::pfenum_DifferentEntityLoginProvider" },
		{ "pfenum_DifferentPlatformType.DisplayName", "DifferentPlatformType" },
		{ "pfenum_DifferentPlatformType.Name", "EDirectPeerConnectivityOptions::pfenum_DifferentPlatformType" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EDirectPeerConnectivityOptions::pfenum_None" },
		{ "pfenum_OnlyServers.DisplayName", "OnlyServers" },
		{ "pfenum_OnlyServers.Name", "EDirectPeerConnectivityOptions::pfenum_OnlyServers" },
		{ "pfenum_SameEntityLoginProvider.DisplayName", "SameEntityLoginProvider" },
		{ "pfenum_SameEntityLoginProvider.Name", "EDirectPeerConnectivityOptions::pfenum_SameEntityLoginProvider" },
		{ "pfenum_SamePlatformType.DisplayName", "SamePlatformType" },
		{ "pfenum_SamePlatformType.Name", "EDirectPeerConnectivityOptions::pfenum_SamePlatformType" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "DirectPeerConnectivityOptions" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EDirectPeerConnectivityOptions::pfenum_None", (int64)EDirectPeerConnectivityOptions::pfenum_None },
		{ "EDirectPeerConnectivityOptions::pfenum_SamePlatformType", (int64)EDirectPeerConnectivityOptions::pfenum_SamePlatformType },
		{ "EDirectPeerConnectivityOptions::pfenum_DifferentPlatformType", (int64)EDirectPeerConnectivityOptions::pfenum_DifferentPlatformType },
		{ "EDirectPeerConnectivityOptions::pfenum_AnyPlatformType", (int64)EDirectPeerConnectivityOptions::pfenum_AnyPlatformType },
		{ "EDirectPeerConnectivityOptions::pfenum_SameEntityLoginProvider", (int64)EDirectPeerConnectivityOptions::pfenum_SameEntityLoginProvider },
		{ "EDirectPeerConnectivityOptions::pfenum_DifferentEntityLoginProvider", (int64)EDirectPeerConnectivityOptions::pfenum_DifferentEntityLoginProvider },
		{ "EDirectPeerConnectivityOptions::pfenum_AnyEntityLoginProvider", (int64)EDirectPeerConnectivityOptions::pfenum_AnyEntityLoginProvider },
		{ "EDirectPeerConnectivityOptions::pfenum_AnyPlatformTypeAndEntityLoginProvider", (int64)EDirectPeerConnectivityOptions::pfenum_AnyPlatformTypeAndEntityLoginProvider },
		{ "EDirectPeerConnectivityOptions::pfenum_OnlyServers", (int64)EDirectPeerConnectivityOptions::pfenum_OnlyServers },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EDirectPeerConnectivityOptions",
	"EDirectPeerConnectivityOptions",
	Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions()
{
	if (!Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.InnerSingleton, Z_Construct_UEnum_PlayFab_EDirectPeerConnectivityOptions_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions.InnerSingleton;
}
// End Enum EDirectPeerConnectivityOptions

// Begin Enum EMembershipLock
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EMembershipLock;
static UEnum* EMembershipLock_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EMembershipLock.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EMembershipLock.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EMembershipLock, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EMembershipLock"));
	}
	return Z_Registration_Info_UEnum_EMembershipLock.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EMembershipLock>()
{
	return EMembershipLock_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EMembershipLock_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** MembershipLock */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Locked.DisplayName", "Locked" },
		{ "pfenum_Locked.Name", "EMembershipLock::pfenum_Locked" },
		{ "pfenum_Unlocked.DisplayName", "Unlocked" },
		{ "pfenum_Unlocked.Name", "EMembershipLock::pfenum_Unlocked" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "MembershipLock" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EMembershipLock::pfenum_Unlocked", (int64)EMembershipLock::pfenum_Unlocked },
		{ "EMembershipLock::pfenum_Locked", (int64)EMembershipLock::pfenum_Locked },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EMembershipLock",
	"EMembershipLock",
	Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EMembershipLock()
{
	if (!Z_Registration_Info_UEnum_EMembershipLock.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EMembershipLock.InnerSingleton, Z_Construct_UEnum_PlayFab_EMembershipLock_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EMembershipLock.InnerSingleton;
}
// End Enum EMembershipLock

// Begin Enum EOsPlatform
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EOsPlatform;
static UEnum* EOsPlatform_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EOsPlatform.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EOsPlatform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EOsPlatform, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EOsPlatform"));
	}
	return Z_Registration_Info_UEnum_EOsPlatform.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EOsPlatform>()
{
	return EOsPlatform_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EOsPlatform_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EOsPlatform",
	"EOsPlatform",
	Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EOsPlatform()
{
	if (!Z_Registration_Info_UEnum_EOsPlatform.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EOsPlatform.InnerSingleton, Z_Construct_UEnum_PlayFab_EOsPlatform_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EOsPlatform.InnerSingleton;
}
// End Enum EOsPlatform

// Begin Enum EOwnerMigrationPolicy
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EOwnerMigrationPolicy;
static UEnum* EOwnerMigrationPolicy_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EOwnerMigrationPolicy.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EOwnerMigrationPolicy.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EOwnerMigrationPolicy"));
	}
	return Z_Registration_Info_UEnum_EOwnerMigrationPolicy.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EOwnerMigrationPolicy>()
{
	return EOwnerMigrationPolicy_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** OwnerMigrationPolicy */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Automatic.DisplayName", "Automatic" },
		{ "pfenum_Automatic.Name", "EOwnerMigrationPolicy::pfenum_Automatic" },
		{ "pfenum_Manual.DisplayName", "Manual" },
		{ "pfenum_Manual.Name", "EOwnerMigrationPolicy::pfenum_Manual" },
		{ "pfenum_None.DisplayName", "None" },
		{ "pfenum_None.Name", "EOwnerMigrationPolicy::pfenum_None" },
		{ "pfenum_Server.DisplayName", "Server" },
		{ "pfenum_Server.Name", "EOwnerMigrationPolicy::pfenum_Server" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "OwnerMigrationPolicy" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EOwnerMigrationPolicy::pfenum_None", (int64)EOwnerMigrationPolicy::pfenum_None },
		{ "EOwnerMigrationPolicy::pfenum_Automatic", (int64)EOwnerMigrationPolicy::pfenum_Automatic },
		{ "EOwnerMigrationPolicy::pfenum_Manual", (int64)EOwnerMigrationPolicy::pfenum_Manual },
		{ "EOwnerMigrationPolicy::pfenum_Server", (int64)EOwnerMigrationPolicy::pfenum_Server },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EOwnerMigrationPolicy",
	"EOwnerMigrationPolicy",
	Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy()
{
	if (!Z_Registration_Info_UEnum_EOwnerMigrationPolicy.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EOwnerMigrationPolicy.InnerSingleton, Z_Construct_UEnum_PlayFab_EOwnerMigrationPolicy_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EOwnerMigrationPolicy.InnerSingleton;
}
// End Enum EOwnerMigrationPolicy

// Begin Enum EPartyInvitationRevocability
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EPartyInvitationRevocability;
static UEnum* EPartyInvitationRevocability_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EPartyInvitationRevocability.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EPartyInvitationRevocability.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EPartyInvitationRevocability"));
	}
	return Z_Registration_Info_UEnum_EPartyInvitationRevocability.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EPartyInvitationRevocability>()
{
	return EPartyInvitationRevocability_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** PartyInvitationRevocability */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Anyone.DisplayName", "Anyone" },
		{ "pfenum_Anyone.Name", "EPartyInvitationRevocability::pfenum_Anyone" },
		{ "pfenum_Creator.DisplayName", "Creator" },
		{ "pfenum_Creator.Name", "EPartyInvitationRevocability::pfenum_Creator" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "PartyInvitationRevocability" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EPartyInvitationRevocability::pfenum_Creator", (int64)EPartyInvitationRevocability::pfenum_Creator },
		{ "EPartyInvitationRevocability::pfenum_Anyone", (int64)EPartyInvitationRevocability::pfenum_Anyone },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EPartyInvitationRevocability",
	"EPartyInvitationRevocability",
	Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability()
{
	if (!Z_Registration_Info_UEnum_EPartyInvitationRevocability.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EPartyInvitationRevocability.InnerSingleton, Z_Construct_UEnum_PlayFab_EPartyInvitationRevocability_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EPartyInvitationRevocability.InnerSingleton;
}
// End Enum EPartyInvitationRevocability

// Begin Enum EProtocolType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EProtocolType;
static UEnum* EProtocolType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EProtocolType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EProtocolType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EProtocolType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EProtocolType"));
	}
	return Z_Registration_Info_UEnum_EProtocolType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EProtocolType>()
{
	return EProtocolType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EProtocolType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EProtocolType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EProtocolType",
	"EProtocolType",
	Z_Construct_UEnum_PlayFab_EProtocolType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EProtocolType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EProtocolType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EProtocolType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EProtocolType()
{
	if (!Z_Registration_Info_UEnum_EProtocolType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EProtocolType.InnerSingleton, Z_Construct_UEnum_PlayFab_EProtocolType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EProtocolType.InnerSingleton;
}
// End Enum EProtocolType

// Begin Enum ERoutingType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ERoutingType;
static UEnum* ERoutingType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ERoutingType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ERoutingType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ERoutingType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ERoutingType"));
	}
	return Z_Registration_Info_UEnum_ERoutingType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ERoutingType>()
{
	return ERoutingType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ERoutingType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_Internet.DisplayName", "Internet" },
		{ "pfenum_Internet.Name", "ERoutingType::pfenum_Internet" },
		{ "pfenum_Microsoft.DisplayName", "Microsoft" },
		{ "pfenum_Microsoft.Name", "ERoutingType::pfenum_Microsoft" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "RoutingType" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "ERoutingType::pfenum_Microsoft", (int64)ERoutingType::pfenum_Microsoft },
		{ "ERoutingType::pfenum_Internet", (int64)ERoutingType::pfenum_Internet },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ERoutingType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ERoutingType",
	"ERoutingType",
	Z_Construct_UEnum_PlayFab_ERoutingType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ERoutingType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ERoutingType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ERoutingType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ERoutingType()
{
	if (!Z_Registration_Info_UEnum_ERoutingType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ERoutingType.InnerSingleton, Z_Construct_UEnum_PlayFab_ERoutingType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ERoutingType.InnerSingleton;
}
// End Enum ERoutingType

// Begin Enum EServerType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EServerType;
static UEnum* EServerType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EServerType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EServerType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_EServerType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("EServerType"));
	}
	return Z_Registration_Info_UEnum_EServerType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<EServerType>()
{
	return EServerType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_EServerType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_EServerType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"EServerType",
	"EServerType",
	Z_Construct_UEnum_PlayFab_EServerType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EServerType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_EServerType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_EServerType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_EServerType()
{
	if (!Z_Registration_Info_UEnum_EServerType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EServerType.InnerSingleton, Z_Construct_UEnum_PlayFab_EServerType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EServerType.InnerSingleton;
}
// End Enum EServerType

// Begin Enum ESubscriptionType
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESubscriptionType;
static UEnum* ESubscriptionType_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ESubscriptionType.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ESubscriptionType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ESubscriptionType, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ESubscriptionType"));
	}
	return Z_Registration_Info_UEnum_ESubscriptionType.OuterSingleton;
}
template<> PLAYFAB_API UEnum* StaticEnum<ESubscriptionType>()
{
	return ESubscriptionType_StaticEnum();
}
struct Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** SubscriptionType */" },
#endif
		{ "ModuleRelativePath", "Classes/PlayFabEnums.h" },
		{ "pfenum_LobbyChange.DisplayName", "LobbyChange" },
		{ "pfenum_LobbyChange.Name", "ESubscriptionType::pfenum_LobbyChange" },
		{ "pfenum_LobbyInvite.DisplayName", "LobbyInvite" },
		{ "pfenum_LobbyInvite.Name", "ESubscriptionType::pfenum_LobbyInvite" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "SubscriptionType" },
#endif
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "ESubscriptionType::pfenum_LobbyChange", (int64)ESubscriptionType::pfenum_LobbyChange },
		{ "ESubscriptionType::pfenum_LobbyInvite", (int64)ESubscriptionType::pfenum_LobbyInvite },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ESubscriptionType",
	"ESubscriptionType",
	Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ESubscriptionType()
{
	if (!Z_Registration_Info_UEnum_ESubscriptionType.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESubscriptionType.InnerSingleton, Z_Construct_UEnum_PlayFab_ESubscriptionType_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ESubscriptionType.InnerSingleton;
}
// End Enum ESubscriptionType

// Begin Enum ETitleMultiplayerServerEnabledStatus
static FEnumRegistrationInfo Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus;
static UEnum* ETitleMultiplayerServerEnabledStatus_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.OuterSingleton)
	{
		Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus, (UObject*)Z_Construct_UPackage__Script_PlayFab(), TEXT("ETitleMultiplayerServerEnabledStatus"));
	}
	return Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.OuterSingleton;
}
...
struct Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_PlayFab,
	nullptr,
	"ETitleMultiplayerServerEnabledStatus",
	"ETitleMultiplayerServerEnabledStatus",
	Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::Enum_MetaDataParams), Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus()
{
	if (!Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.InnerSingleton, Z_Construct_UEnum_PlayFab_ETitleMultiplayerServerEnabledStatus_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus.InnerSingleton;
}
// End Enum ETitleMultiplayerServerEnabledStatus

// Begin Registration
struct Z_CompiledInDeferFile_FID_UEProjects_Popcorn_Plugins_PlayFabPlugin_PlayFab_Source_PlayFab_Classes_PlayFabEnums_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EAuthTokenType_StaticEnum, TEXT("EAuthTokenType"), &Z_Registration_Info_UEnum_EAuthTokenType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3239318021U) },
		{ EChurnRiskLevel_StaticEnum, TEXT("EChurnRiskLevel"), &Z_Registration_Info_UEnum_EChurnRiskLevel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1805762264U) },
		{ EConditionals_StaticEnum, TEXT("EConditionals"), &Z_Registration_Info_UEnum_EConditionals, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1640576213U) },
		{ EContinentCode_StaticEnum, TEXT("EContinentCode"), &Z_Registration_Info_UEnum_EContinentCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1617027644U) },
		{ ECountryCode_StaticEnum, TEXT("ECountryCode"), &Z_Registration_Info_UEnum_ECountryCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4008283465U) },
		{ ECurrency_StaticEnum, TEXT("ECurrency"), &Z_Registration_Info_UEnum_ECurrency, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3318656299U) },
		{ EEffectType_StaticEnum, TEXT("EEffectType"), &Z_Registration_Info_UEnum_EEffectType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1549262495U) },
		{ EEmailVerificationStatus_StaticEnum, TEXT("EEmailVerificationStatus"), &Z_Registration_Info_UEnum_EEmailVerificationStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 514992589U) },
		{ ELoginIdentityProvider_StaticEnum, TEXT("ELoginIdentityProvider"), &Z_Registration_Info_UEnum_ELoginIdentityProvider, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1453359727U) },
		{ EPushNotificationPlatform_StaticEnum, TEXT("EPushNotificationPlatform"), &Z_Registration_Info_UEnum_EPushNotificationPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 949224930U) },
		{ EPushSetupPlatform_StaticEnum, TEXT("EPushSetupPlatform"), &Z_Registration_Info_UEnum_EPushSetupPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 938995796U) },
		{ EResolutionOutcome_StaticEnum, TEXT("EResolutionOutcome"), &Z_Registration_Info_UEnum_EResolutionOutcome, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3416311697U) },
		{ EResultTableNodeType_StaticEnum, TEXT("EResultTableNodeType"), &Z_Registration_Info_UEnum_EResultTableNodeType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 19487621U) },
		{ EScheduledTaskType_StaticEnum, TEXT("EScheduledTaskType"), &Z_Registration_Info_UEnum_EScheduledTaskType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1135523702U) },
		{ ESegmentCountryCode_StaticEnum, TEXT("ESegmentCountryCode"), &Z_Registration_Info_UEnum_ESegmentCountryCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 422875046U) },
		{ ESegmentCurrency_StaticEnum, TEXT("ESegmentCurrency"), &Z_Registration_Info_UEnum_ESegmentCurrency, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 817145936U) },
		{ ESegmentFilterComparison_StaticEnum, TEXT("ESegmentFilterComparison"), &Z_Registration_Info_UEnum_ESegmentFilterComparison, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4098616344U) },
		{ ESegmentLoginIdentityProvider_StaticEnum, TEXT("ESegmentLoginIdentityProvider"), &Z_Registration_Info_UEnum_ESegmentLoginIdentityProvider, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3952910697U) },
		{ ESegmentPushNotificationDevicePlatform_StaticEnum, TEXT("ESegmentPushNotificationDevicePlatform"), &Z_Registration_Info_UEnum_ESegmentPushNotificationDevicePlatform, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3701072255U) },
		{ EPfSourceType_StaticEnum, TEXT("EPfSourceType"), &Z_Registration_Info_UEnum_EPfSourceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2287375751U) },
		{ EStatisticAggregationMethod_StaticEnum, TEXT("EStatisticAggregationMethod"), &Z_Registration_Info_UEnum_EStatisticAggregationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 750685465U) },
		{ EStatisticResetIntervalOption_StaticEnum, TEXT("EStatisticResetIntervalOption"), &Z_Registration_Info_UEnum_EStatisticResetIntervalOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2487288479U) },
		{ EStatisticVersionArchivalStatus_StaticEnum, TEXT("EStatisticVersionArchivalStatus"), &Z_Registration_Info_UEnum_EStatisticVersionArchivalStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3972815676U) },
		{ EStatisticVersionStatus_StaticEnum, TEXT("EStatisticVersionStatus"), &Z_Registration_Info_UEnum_EStatisticVersionStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3441058005U) },
		{ ESubscriptionProviderStatus_StaticEnum, TEXT("ESubscriptionProviderStatus"), &Z_Registration_Info_UEnum_ESubscriptionProviderStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2363791204U) },
		{ ETaskInstanceStatus_StaticEnum, TEXT("ETaskInstanceStatus"), &Z_Registration_Info_UEnum_ETaskInstanceStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1591116796U) },
		{ ETitleActivationStatus_StaticEnum, TEXT("ETitleActivationStatus"), &Z_Registration_Info_UEnum_ETitleActivationStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4151241774U) },
		{ EUserDataPermission_StaticEnum, TEXT("EUserDataPermission"), &Z_Registration_Info_UEnum_EUserDataPermission, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1870255616U) },
		{ EUserFamilyType_StaticEnum, TEXT("EUserFamilyType"), &Z_Registration_Info_UEnum_EUserFamilyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 95076161U) },
		{ EUserOrigination_StaticEnum, TEXT("EUserOrigination"), &Z_Registration_Info_UEnum_EUserOrigination, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2939037284U) },
		{ EAdActivity_StaticEnum, TEXT("EAdActivity"), &Z_Registration_Info_UEnum_EAdActivity, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1426372298U) },
		{ ECloudScriptRevisionOption_StaticEnum, TEXT("ECloudScriptRevisionOption"), &Z_Registration_Info_UEnum_ECloudScriptRevisionOption, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 814663451U) },
		{ EExternalFriendSources_StaticEnum, TEXT("EExternalFriendSources"), &Z_Registration_Info_UEnum_EExternalFriendSources, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1203955138U) },
		{ ETradeStatus_StaticEnum, TEXT("ETradeStatus"), &Z_Registration_Info_UEnum_ETradeStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2592808038U) },
		{ ETransactionStatus_StaticEnum, TEXT("ETransactionStatus"), &Z_Registration_Info_UEnum_ETransactionStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1921655357U) },
		{ EIdentifiedDeviceType_StaticEnum, TEXT("EIdentifiedDeviceType"), &Z_Registration_Info_UEnum_EIdentifiedDeviceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1998917319U) },
		{ EPfTriggerType_StaticEnum, TEXT("EPfTriggerType"), &Z_Registration_Info_UEnum_EPfTriggerType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1833957718U) },
		{ EOperationTypes_StaticEnum, TEXT("EOperationTypes"), &Z_Registration_Info_UEnum_EOperationTypes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2147554322U) },
		{ EConcernCategory_StaticEnum, TEXT("EConcernCategory"), &Z_Registration_Info_UEnum_EConcernCategory, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3077196733U) },
		{ EDisplayPropertyType_StaticEnum, TEXT("EDisplayPropertyType"), &Z_Registration_Info_UEnum_EDisplayPropertyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1157852983U) },
		{ EHelpfulnessVote_StaticEnum, TEXT("EHelpfulnessVote"), &Z_Registration_Info_UEnum_EHelpfulnessVote, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1965493264U) },
		{ EModerationStatus_StaticEnum, TEXT("EModerationStatus"), &Z_Registration_Info_UEnum_EModerationStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1243069743U) },
		{ EPublishResult_StaticEnum, TEXT("EPublishResult"), &Z_Registration_Info_UEnum_EPublishResult, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 890527512U) },
		{ EAnalysisTaskState_StaticEnum, TEXT("EAnalysisTaskState"), &Z_Registration_Info_UEnum_EAnalysisTaskState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3918625512U) },
		{ EExperimentState_StaticEnum, TEXT("EExperimentState"), &Z_Registration_Info_UEnum_EExperimentState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3453827794U) },
		{ EExperimentType_StaticEnum, TEXT("EExperimentType"), &Z_Registration_Info_UEnum_EExperimentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1375896010U) },
		{ ELeaderboardSortDirection_StaticEnum, TEXT("ELeaderboardSortDirection"), &Z_Registration_Info_UEnum_ELeaderboardSortDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4131510189U) },
		{ EResetInterval_StaticEnum, TEXT("EResetInterval"), &Z_Registration_Info_UEnum_EResetInterval, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1520852116U) },
		{ EAccessPolicy_StaticEnum, TEXT("EAccessPolicy"), &Z_Registration_Info_UEnum_EAccessPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2123367478U) },
		{ EAzureRegion_StaticEnum, TEXT("EAzureRegion"), &Z_Registration_Info_UEnum_EAzureRegion, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 741293731U) },
		{ EAzureVmFamily_StaticEnum, TEXT("EAzureVmFamily"), &Z_Registration_Info_UEnum_EAzureVmFamily, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3379211389U) },
		{ EAzureVmSize_StaticEnum, TEXT("EAzureVmSize"), &Z_Registration_Info_UEnum_EAzureVmSize, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 41749732U) },
		{ ECancellationReason_StaticEnum, TEXT("ECancellationReason"), &Z_Registration_Info_UEnum_ECancellationReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2901022240U) },
		{ EContainerFlavor_StaticEnum, TEXT("EContainerFlavor"), &Z_Registration_Info_UEnum_EContainerFlavor, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1849295348U) },
		{ EDirectPeerConnectivityOptions_StaticEnum, TEXT("EDirectPeerConnectivityOptions"), &Z_Registration_Info_UEnum_EDirectPeerConnectivityOptions, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1229393336U) },
		{ EMembershipLock_StaticEnum, TEXT("EMembershipLock"), &Z_Registration_Info_UEnum_EMembershipLock, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1610784913U) },
		{ EOsPlatform_StaticEnum, TEXT("EOsPlatform"), &Z_Registration_Info_UEnum_EOsPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 859645163U) },
		{ EOwnerMigrationPolicy_StaticEnum, TEXT("EOwnerMigrationPolicy"), &Z_Registration_Info_UEnum_EOwnerMigrationPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3582139521U) },
		{ EPartyInvitationRevocability_StaticEnum, TEXT("EPartyInvitationRevocability"), &Z_Registration_Info_UEnum_EPartyInvitationRevocability, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 138733321U) },
		{ EProtocolType_StaticEnum, TEXT("EProtocolType"), &Z_Registration_Info_UEnum_EProtocolType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4174840708U) },
		{ ERoutingType_StaticEnum, TEXT("ERoutingType"), &Z_Registration_Info_UEnum_ERoutingType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2531359017U) },
		{ EServerType_StaticEnum, TEXT("EServerType"), &Z_Registration_Info_UEnum_EServerType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2958515227U) },
		{ ESubscriptionType_StaticEnum, TEXT("ESubscriptionType"), &Z_Registration_Info_UEnum_ESubscriptionType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2142761323U) },
		{ ETitleMultiplayerServerEnabledStatus_StaticEnum, TEXT("ETitleMultiplayerServerEnabledStatus"), &Z_Registration_Info_UEnum_ETitleMultiplayerServerEnabledStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2165666586U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UEProjects_Popcorn_Plugins_PlayFabPlugin_PlayFab_Source_PlayFab_Classes_PlayFabEnums_h_3188785768(TEXT("/Script/PlayFab"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_UEProjects_Popcorn_Plugins_PlayFabPlugin_PlayFab_Source_PlayFab_Classes_PlayFabEnums_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UEProjects_Popcorn_Plugins_PlayFabPlugin_PlayFab_Source_PlayFab_Classes_PlayFabEnums_h_Statics::EnumInfo));
// End Registration
